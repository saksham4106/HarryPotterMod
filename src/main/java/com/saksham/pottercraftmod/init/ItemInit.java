...
import com.saksham.pottercraftmod.items.FlooPowderItem;
import com.saksham.pottercraftmod.items.NameplateItem;
import com.saksham.pottercraftmod.items.SpellItem;
import com.saksham.pottercraftmod.items.TestItem;
import com.saksham.pottercraftmod.items.WandItem;
import com.saksham.pottercraftmod.items.hallows.InvisibilityCloak;
import com.saksham.pottercraftmod.util.ModArmorMaterial;
...
public class ItemInit {
	...
	public static final RegistryObject<Item> INVISIBILITY_CLOAK = ITEMS.register("invisibility_cloak",
			() -> new InvisibilityCloak(ModArmorMaterial.INVISIBITY_CLOAK, EquipmentSlotType.HEAD,  new Item.Properties().group(itemGroup)));
