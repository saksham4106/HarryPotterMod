...
public enum ModArmorMaterial implements IArmorMaterial{
	...
	INVISIBITY_CLOAK("invisibility", 2, new int[] {1,2,1,2} , 0, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0f, () -> {return Ingredient.fromItems(ItemInit.INVISIBILITY_CLOAK.get());});
